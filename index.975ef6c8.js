...
${frame.code}`;
    ...
    "8lqZg": [
      ...
      {
        "./js/burger-menu": "egJfa",
        "./js/translate": "cybGd",
        "./js/news": "2xmvE",
        "./js/main-gallary": "lneWe",
      },
    ],
    egJfa: [
      function (require, module, exports) {
    ...
    lneWe: [
      function (require, module, exports) {
        ...
        var _lgAutoplayMinDefault =
          parcelHelpers.interopDefault(_lgAutoplayMin);
        var _lgThumbnailMin = require("../plugins/thumbnail/lg-thumbnail.min");
        var _lgThumbnailMinDefault =
          parcelHelpers.interopDefault(_lgThumbnailMin);
        var _dynamicMainGallaryElJson = require("./source/DynamicMainGallaryEl.json");
        var _dynamicMainGallaryElJsonDefault = parcelHelpers.interopDefault(
          _dynamicMainGallaryElJson
        );
      ...
      {
        lightgallery: "lrONo",
        "../plugins/autoplay/lg-autoplay.min": "e554u",
        "../plugins/thumbnail/lg-thumbnail.min": "jSejr",
        "./source/DynamicMainGallaryEl.json": "eQ9eW",
...
***************************************************************************** */ var __assign =
        ...
        var lgQuery = /** @class */ (function () {
          ...
          lgQuery1.prototype._setCssVendorPrefix = function (
            el,
            cssProperty,
            value
          ) {
          ...
          lgQuery1.prototype.on = function (events, listener) {
            ...
            events.split(" ").forEach(function (event) {
              if (!Array.isArray(lgQuery1.eventListeners[event]))
                lgQuery1.eventListeners[event] = [];
        ...
        var LightGallery = /** @class */ (function () {
          ...
          LightGallery1.prototype.resizeVideoSlide = function (
            index,
            imageSize
          ) {
          ...
          LightGallery1.prototype.setMediaContainerPosition = function (
            top,
            bottom
          ) {
            if (top === void 0) top = 0;
          ...
          LightGallery1.prototype.getDummyImageContent = function (
            $currentSlide,
            index,
            alt
          ) {
          ...
          LightGallery1.prototype.setImgMarkup = function (
            src,
            $currentSlide,
            index
          ) {
          ...
          LightGallery1.prototype.onSlideObjectLoad = function (
            $slide,
           ...
           * @param isFirstSlide
           */ LightGallery1.prototype.onLgObjectLoad = function (
            currentSlide,
            index,
            delay,
            speed,
          ...
          LightGallery1.prototype.triggerSlideItemLoad = function (
            $currentSlide,
            index,
            delay,
            speed,
           ...
           * @param $currentSlide
           * @param speed
           */ LightGallery1.prototype.loadContentOnFirstSlideLoad = function (
            index,
            $currentSlide,
            speed
          ) {
          ...
          LightGallery1.prototype.getItemsToBeInsertedToDom = function (
            index2,
            prevIndex,
            numberOfItems
          ) {
            ...
            if (index2 < (this.galleryItems.length - 1) / 2) {
              for (
                var idx = index2;
                idx > index2 - possibleNumberOfItems / 2 && idx >= 0;
                idx--
              )
              ...
              for (
                ...
                itemsToBeInsertedToDom.push(
                  "lg-item-" + this.lgId + "-" + (index2 + idx + 1)
                );
            } else {
              for (
                var idx = index2;
                idx <= this.galleryItems.length - 1 &&
                idx < index2 + possibleNumberOfItems / 2;
                idx++
              )
                itemsToBeInsertedToDom.push("lg-item-" + this.lgId + "-" + idx);
              var numberOfExistingItems = itemsToBeInsertedToDom.length;
          ...
          LightGallery1.prototype.organizeSlideItems = function (
            index,
            prevIndex
          ) {
            var _this = this;
          ...
          LightGallery1.prototype.makeSlideAnimation = function (
            direction,
            currentSlideItem,
            previousSlideItem
          ) {
           ...
           *  plugin.slide(2);
           *
           */ LightGallery1.prototype.slide = function (
            index,
            fromTouch,
            fromThumb,
            direction
          ...
          LightGallery1.prototype.touchMove = function (
            startCoords,
            endCoords,
            e
          ) {
          ...
          LightGallery1.prototype.touchEnd = function (
            endCoords,
            startCoords,
            event
          ) {
          ...
          LightGallery1.prototype.setTranslate = function (
            $el,
            xValue,
            yValue,
            scaleX,
         ...
         */ !(function (t, o) {
          ...
          return (function () {
            function p(o) {
              return (
                (this.core = o),
                (this.settings = t1(t1({}, u), this.core.settings)),
                this
              );
            }
            return (
              (p.prototype.init = function () {
                ...
                this.settings.autoplay &&
                  ...
                  this.settings.slideShowAutoplay &&
                    this.core.LGel.once(o1 + ".autoplay", function () {
                      t.startAutoPlay();
                    }),
                  this.core.LGel.on(
                    r1 + ".autoplay touchstart.lg.autoplay",
                    function () {
                      t.interval &&
                        (t.stopAutoPlay(), (t.pausedOnTouchDrag = !0));
                    }
                  ),
                  this.core.LGel.on(
                    i + ".autoplay touchend.lg.autoplay",
                    function () {
                      !t.interval &&
                        t.pausedOnTouchDrag &&
          ...
          return (function () {
            ...
            return (
              (o.prototype.init = function () {
                (this.settings = t1(t1({}, e1), this.core.settings)),
                  (this.thumbOuterWidth = 0),
              ...
              (o.prototype.build = function () {
                ...
                this.setThumbMarkup(),
                  ...
                  this.$lgThumb
                    .first()
                    .on("click.lg touchend.lg", function (e2) {
